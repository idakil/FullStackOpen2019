...
describe('return total likes', () => {
  ...
  test('total like with mutiple blogs', () => {
...
test('get person with most likes', () => {
  const personWithMostLikes = {
    author: "Edsger W. Dijkstra",
    likes: 17,
  }
  const result = listHelper.mostLikes(multipleBlogs)
  expect(result).toEqual(personWithMostLikes)
